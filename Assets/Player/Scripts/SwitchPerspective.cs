...
public class SwitchPerspective : MonoBehaviour
{
    ...
    Dictionary<Perspective, ContainerName> containerNameByPerspective = new
    Dictionary<Perspective, ContainerName>();
    Dictionary<ContainerName, Transform> containerByName = new
    Dictionary<ContainerName, Transform>();
    void Start()
    {
    ...
    void InitialiseContainers()
    {
        ...
        containerByName.Add(ContainerName.Container1P,
        gameObject.transform.Find(ContainerName.Container1P.ToString()));
        containerByName.Add(ContainerName.Container3P,
        gameObject.transform.Find(ContainerName.Container3P.ToString()));
    }
